...
``` 
ragul@DEV-STATION MINGW64 /c
$ git clone https://github.com/ragulkumar/uber-expenses-tracking.git
```
...
ragul@DEV-STATION MINGW64 /c/Uber-expenses-tracking
$ cd code
```

```linux 
ragul@DEV-STATION MINGW64 /c/Uber-expenses-tracking/code
...
## Maintainer
- **Ragul Kumar Venkateswaran** - Data Engineer
- Email: ragulkumar2611@gmail.com
- Based on the original implementation by Ramses Alexander Coraspe Valdez (2021)

## About the Developer
Ragul Kumar Venkateswaran is a Data Engineer with over 4 years of experience designing and maintaining scalable data pipelines, models, and BI solutions across GCP, Azure, and Snowflake. He specializes in Python, SQL, and Airflow for ETL automation and data orchestration, delivering high-performance data systems that drive strategic decision-making.
